...
public class effectTranss : MonoBehaviour
{
	public CanvasGroup GroupText;
	public ModeleffectTransAnimation Block;
	public ModeleffectTransAnimation Box;
	public ModeleffectTransAnimation Bubble;
	public ModeleffectTransAnimation Circle;
	public ModeleffectTransAnimation Claw;
	public ModeleffectTransAnimation Consume;
	public ModeleffectTransAnimation Dark;
	public ModeleffectTransAnimation Earth;
	public ModeleffectTransAnimation Electric;
	public ModeleffectTransAnimation Explode;
	public ModeleffectTransAnimation Fire;
	public ModeleffectTransAnimation Footprints;
	public ModeleffectTransAnimation Glint;
	public ModeleffectTransAnimation Heal;
	public ModeleffectTransAnimation Ice;
	public ModeleffectTransAnimation Lightning;
	public ModeleffectTransAnimation Nuclear;
	public ModeleffectTransAnimation Poison;
	public ModeleffectTransAnimation Puff;
	public ModeleffectTransAnimation Shield;
	public ModeleffectTransAnimation Slash;
	public ModeleffectTransAnimation Sparks;
	public ModeleffectTransAnimation SplatterBlood;
	public ModeleffectTransAnimation SplatterSlime;
	public ModeleffectTransAnimation Square;
	public ModeleffectTransAnimation Star;
	public ModeleffectTransAnimation Teleport;
	public ModeleffectTransAnimation Touch;
	public ModeleffectTransAnimation Warp;
	public ModeleffectTransAnimation Water;
	public ModeleffectTransAnimation Web;
	Pool _pool;
	...
	public void Trigger(ModeleffectTransAnimation model, Vector2 p,
