...
1. Create empty game object, add TileMap. Set sheet image and layers and matching material.
	...
	c. Maps based on Level.png use fifteen layers: Back, Blood, Fore, Flower, SplitBack, SplitBackWater, SplitBackFog, Tree, SplitFore, SplitForeWater, SplitForeFog, Top, effectTrans, Light, Edge.
2. Run.
